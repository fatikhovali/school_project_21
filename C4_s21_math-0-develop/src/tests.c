...
START_TEST(s21_tan_f) {
  ...
  ck_assert_ldouble_eq_tol(s21_tan(value), tanl(value), 1e-7);
  value = S21_PI / 2;
  ck_assert_ldouble_eq(s21_tan(value) == NAN, tanl(value) == NAN);
  value = 1;
  ck_assert_ldouble_eq_tol(s21_tan(value), tanl(value), 1e-7);
  value = 0.777777;
  ck_assert_ldouble_eq_tol(s21_tan(value), tanl(value), 1e-7);
...
START_TEST(s21_cos_f) {
  ...
  ck_assert_ldouble_eq_tol(s21_cos(value), cosl(value), 1e-7);
  value = -INFINITY;
  ck_assert_ldouble_eq(s21_cos(value) == NAN, cosl(value) == NAN);
  for (double i = -S21_PI; i < S21_PI; i += 0.001) {
...
START_TEST(s21_sin_f) {
  ...
  value = -0.7777777;
  ck_assert_ldouble_eq_tol(s21_sin(value), sinl(value), 1e-7);
  value = 5555555555.555555;
  ck_assert_ldouble_eq_tol(s21_sin(value), sinl(value), 1e-7);
  value = -5555555555.555555;
  ck_assert_ldouble_eq_tol(s21_sin(value), sinl(value), 1e-7);
  value = INFINITY;
  ck_assert_ldouble_eq(s21_sin(value) == NAN, sinl(value) == NAN);
  for (double i = -S21_PI; i < S21_PI; i += 0.001) {
...
START_TEST(s21_fmod_f) {
  ck_assert_ldouble_eq(s21_fmod(456.87678, 0) == NAN,
                       fmod(456.87678, 0) == NAN);
  ...
  ck_assert_ldouble_eq_tol(s21_fmod(23.456, -4.355), fmod(23.456, -4.355),
                           1e-7);
  ck_assert_ldouble_eq_tol(s21_fmod(256.858, 0.05), fmod(256.858, 0.05), 1e-7);
  ck_assert_ldouble_eq_tol(s21_fmod(1e-18, -950.05), fmod(1e-18, -950.05),
                           1e-7);
  ck_assert_ldouble_eq_tol(s21_fmod(1e10, -950.05), fmod(1e10, -950.05), 1e-7);
  ck_assert_ldouble_eq_tol(s21_fmod(-50.05, 8), fmod(-50.05, 8), 1e-7);
  ck_assert_ldouble_eq_tol(s21_fmod(-50.05, INFINITY), fmod(-50.05, INFINITY),
                           1e-7);
  ck_assert_ldouble_eq_tol(s21_fmod(-1, 1), fmod(-1, 1), 1e-7);
}
END_TEST
...
START_TEST(s21_log_f) {
  ...
  value = S21_INF;
  ck_assert_int_eq(s21_log(value) == S21_INF, logl(value) == S21_INF);
  value = S21_NAN;
  ck_assert_int_eq(s21_log((value)) == S21_NAN, logl((value)) == S21_NAN);
}
END_TEST
...
START_TEST(s21_pow_f) {
  ...
  ck_assert_ldouble_eq(s21_pow(1234567890123, -654321),
                       pow(1234567890123, -654321));
  ck_assert_ldouble_eq(s21_pow(0, -654321), pow(0, -654321));
}
END_TEST
